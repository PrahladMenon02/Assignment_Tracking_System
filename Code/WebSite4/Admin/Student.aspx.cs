...
public partial class Admin_Student : System.Web.UI.Page
{
    ...
    public void display()
    {
        cmd = new SqlCommand("Select *from tbltstudent", con);
    ...
    {
        string msg = "insert into tbltstudent values( @FirstName, @LastName, @Email, @MobileNo, @UserName, @Password, @Gender,@Class)";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        cmd = new SqlCommand("delete FROM tbltstudent where ID='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        display();
    }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
       ...
       TextBox Class = (TextBox)row.Cells[7].Controls[0];


        GridView1.EditIndex = -1;


        cmd = new SqlCommand("update tbltstudent set Email='" + Email.Text + "',MobileNo='" + Mobileno.Text + "',UserName='" + Username.Text + "',Password='" + Password.Text + "',Class='" + Class.Text   + "'where ID='" + userid + "'", con);
        cmd.ExecuteNonQuery();
