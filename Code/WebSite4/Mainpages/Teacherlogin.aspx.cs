...
using System.Data;
public partial class Mainpages_Teacherlogin : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       cmd = new SqlCommand("select UserName,Password from tblteacher where UserName=@UserName and Password=@Password ", con);
