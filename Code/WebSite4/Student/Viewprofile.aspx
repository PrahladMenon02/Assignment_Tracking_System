<%@ Page Title="" Language="C#" MasterPageFile="Student.master" AutoEventWireup="true" CodeFile="Viewprofile.aspx.cs" Inherits="Student_Viewprofile" %>
        ...
        <tr>
          ...
          <tr><td class="auto-style3">&nbsp;</td><td>&nbsp;</td>
           <td>Gender:</td><td><asp:TextBox ID="TextBox5" runat="server" CssClass="form-control"></asp:TextBox></td>
            ...
            <td>&nbsp;</td>
              <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td><td>Class::</td><td><asp:TextBox ID="TextBox8" runat="server" CssClass="form-control"></asp:TextBox></td>  
             </tr>
         <tr>
            <td class="auto-style3">&nbsp;</td>
        </tr>
