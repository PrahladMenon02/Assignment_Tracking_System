<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="viewDocuments.aspx.cs" Inherits="Student_viewDocuments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <table>
        <tr>
            <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td> <td>&nbsp; </td>
                <td>
                    <asp:Panel ID="Panel1" runat="server" GroupingText="Assignment Details" CssClass="auto-style2" Height="335px" Width="1074px">
                        <table>
                            <tr>
                                <td>
        ...
        <asp:TemplateField HeaderText="Student" HeaderStyle-ForeColor="#cc3300" HeaderStyle-Font-Bold="true">
             ...
             <asp:LinkButton ID="lnkComments" runat="server" Text="Download" CommandName="DownloadFile" CommandArgument='<%#Eval("AssignmentID") %>'/>
                &nbsp;    <asp:LinkButton ID="LinkButton1" runat="server" Text="GuideLines" CommandName="Uploaddgudelines" CommandArgument='<%#Eval("AssignmentID") %>'/>
                    &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" Text="UploadWork" CommandName="Uploadcoursework" CommandArgument='<%#Eval("AssignmentID") %>'/>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:Panel ID="Panel2" runat="server" Font-Bold="true" Visible="false">
        <table align="center">
            <tr>
                <td>C<span lang="EN-SG">ourse</span><span> </span><span lang="EN-SG">work</span>:</td>
                <td>
...
<asp:Label ID="Label1" runat="server" Text="Label" Visible="false"></asp:Label>
    ...
    <asp:Label ID="Label3" runat="server" Text="Unaccepted" Visible="False"></asp:Label>
</asp:Content>
